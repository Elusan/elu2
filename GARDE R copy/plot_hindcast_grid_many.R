...
#' [plot_hindcast_grid_scenario()].
#'
#' @param all_models See [plot_hindcast_grid_scenario()].
#' @param scenario_names Character vector of scenarios to process; default `names(all_models)`.
#' @param ... Passed through to [plot_hindcast_grid_scenario()].
#'
