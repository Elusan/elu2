...
#'
#' Fills in default values if missing. Optionally checks time-dependent objects against the management time and corrects if necessary.
#'
...
#' @param mancheck Should the time-dependent objects in \code{inp} be checked against the management time and corrected if necessary? (Default: TRUE)
#' @details This function checks the input list for the ELU model, fills in missing default values, and can check time-dependent objects against the management time.
#' @return The checked input list, possibly modified or with missing values filled.
#' @export
