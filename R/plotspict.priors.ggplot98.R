...
theme_sleek <- function(base_size = 11, base_family = "") {
  ...
  theme_light(base_size = base_size, base_family = base_family) +
    theme(
      ...
      strip.text.x        = element_text(colour = "grey20", face = "bold",size   = rel(1.2)),
      strip.text.y        = element_text(colour = "grey20",
                                         face   = "bold", size   = rel(1.2)),
      axis.text           = element_text(colour = "grey15", size = 10),
      axis.title          = element_text(colour = "grey15", size = 10),
      #legend.title        = element_text(colour = "grey30", size = rel(0.9)),
      panel.border        = element_rect(fill = NA, colour = "grey28", linewidth = 1.8),

      # tighten legend keys & spacing
      ...
      plot.subtitle       = element_text(colour = "grey20", size = 18, face = "bold")
    )
}
