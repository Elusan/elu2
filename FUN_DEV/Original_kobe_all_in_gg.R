...
Original_kobe_all_in_gg <- function(rep,
  ...
  p <- p + ggplot2::theme_bw() +
    ggplot2::theme(
      ...
      panel.border = ggplot2::element_rect(color = "gray50", fill = NA, linewidth = 0.6),
      ...
      axis.text.x  = element_text(size = 10, face = "bold", colour = "gray50"),
      axis.text.y  = element_text(size = 10, face = "bold", colour = "gray50"),
      axis.title.x = element_text(size = 14, face = "bold", colour = "gray50"),
      axis.title.y = element_text(size = 14, face = "bold", colour = "gray50"),
