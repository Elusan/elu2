 ...
 */
// Modified by Elhadji Ndiaye, 2023–2025, Tokyo University of Marine Science and Technology

// 14.10.2014
#define TMB_LIB_INIT R_init_elu2_tmb
#include <TMB.hpp>
...
{
  // Diagnostic print to confirm correct model is loaded
  Rcout << "<> elu custom spict loaded <>\n";
