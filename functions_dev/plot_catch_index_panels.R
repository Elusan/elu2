  ...
  theme_minimal_compact <- function(base_size = 8, base_family = "") {
    theme_minimal(base_size = base_size, base_family = base_family) +
      theme(
        ...
        axis.title.y.right = element_text(color = "#DC143C", size = 12, face = "bold"),
        axis.text.y.right  = element_text(color = "#DC143C", size = 12, face = "bold"),
        ...
        panel.border = element_rect(fill = NA, colour = "grey45", linewidth = 1.8),
