...
#' @description
#' This function plots the estimated time-varying growth rate from a fitted SPiCT model.
#'
#' @details
#' Time-varying growth is estimated from the stochastic process fitted in SPiCT and plotted with optional confidence intervals.
#'
#' @param rep A result report as generated by running fit.spict.
#' @param logax Take log of y-axis? default: FALSE
#' @param main Title of plot.
